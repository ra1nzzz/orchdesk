...
| 维度 | 状态 | 说明 |
|------|------|------|
| **当前版本** | `0.13.2`（tag `v0.13.2` 已推；Release 待实机冒烟后转正） | SemVer，pre-1.0 阶段 |
| **最新 Commit** | `e3f5b78` | refactor(dsh-runtime): 插件装载三样板收敛 + startRuntime 竞态修复（⑤） |
...
| **验证套件** | 875/875 PASS | `npm run verify`（plugins 88 / orchestration 50 / trace-upload 37 / agent-runtime 40 / agent-loop 14 / model-loop 45 / dsh-runtime 31 / **ipc-guard 4** / credentials 34 / data-dir 47 / data-port 10 / session-fork 29 / memory-promotion 22 / memory-summarize 16 / connector-registry 30 / plugin-market 15 / usage-registry 11 / session-events 16 / ts-loader 13 / browser-tools 44 / terminal-pty 29 / file-panel 20 / **file-edit 20** / arch-guard 15 / e2e 195）—— 25 套件；另设不进链的真机冒烟 `pnpm run smoke:browser`（11/11，需真 GPU/渲染进程） |
...
*最后更新：2026-09-04（第二十三批：dsh-runtime 样板收敛 + 竞态修复｜verify 875 项全绿；第二十二批：IPC sender 校验 + 无界队列加固 + canonical 去重｜verify 875 项全绿；第二十一批：死挂点全盘扫描修复 #44-47 + e2e 组 15 回归 #48｜verify 859 项全绿；第二十批：BUG-023 会话工作区贯通｜verify 832 项全绿）*
