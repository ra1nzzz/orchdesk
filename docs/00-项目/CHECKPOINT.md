...
| **验证套件** | 884/884 PASS | `npm run verify`（plugins 88 / orchestration 50 / trace-upload 37 / agent-runtime 40 / agent-loop 14 / model-loop 45 / dsh-runtime 31 / **ipc-guard 4** / credentials 34 / data-dir 47 / data-port 10 / session-fork 29 / memory-promotion 22 / memory-summarize 16 / connector-registry 30 / plugin-market 15 / usage-registry 11 / session-events 16 / ts-loader 13 / browser-tools 44 / terminal-pty 29 / file-panel 20 / **file-edit 20** / arch-guard 15 / e2e 204）—— 25 套件；另设不进链的真机冒烟 `pnpm run smoke:browser`（11/11，需真 GPU/渲染进程） |
...
*最后更新：2026-09-05（第二十五批：右栏「能力」TAB 改名 + 技能改磁盘真实扫描｜verify 884 项全绿；第二十四批：v0.14.0 发版 + UI 重构四项 + impeccable 审查｜verify 877 项全绿；第二十三批：dsh-runtime 样板收敛 + 竞态修复｜verify 875 项全绿；第二十二批：IPC sender 校验 + 无界队列加固 + canonical 去重｜verify 875 项全绿）*
