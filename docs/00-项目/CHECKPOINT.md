...
| **验证套件** | 873/873 PASS | `npm run verify`（plugins 88 / orchestration 49 / trace-upload 36 / agent-runtime 40 / agent-loop 14 / model-loop 45 / dsh-runtime 31 / **ipc-guard 4** / credentials 34 / data-dir 47 / data-port 10 / session-fork 29 / memory-promotion 22 / memory-summarize 16 / connector-registry 30 / plugin-market 15 / usage-registry 11 / session-events 16 / ts-loader 13 / browser-tools 44 / terminal-pty 29 / file-panel 20 / **file-edit 20** / arch-guard 15 / e2e 195）—— 25 套件；另设不进链的真机冒烟 `pnpm run smoke:browser`（11/11，需真 GPU/渲染进程） |
...
*最后更新：2026-09-03（第二十一批：死挂点全盘扫描修复 #44-47 + e2e 组 15 回归 #48｜verify 859 项全绿；第二十批：BUG-023 会话工作区贯通｜verify 832 项全绿；第十九批：实机冒烟首批 → BUG-022 → v0.13.1）*
