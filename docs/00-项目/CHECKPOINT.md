...
| **最新 Commit** | `6447968` | feat(ui): 待办语义化 + 侧栏重构（文件TAB/浏览器侧栏/终端抽屉）+ 思考链展开 |
...
| **验证套件** | 877/877 PASS | `npm run verify`（plugins 88 / orchestration 50 / trace-upload 37 / agent-runtime 40 / agent-loop 14 / model-loop 45 / dsh-runtime 31 / **ipc-guard 4** / credentials 34 / data-dir 47 / data-port 10 / session-fork 29 / memory-promotion 22 / memory-summarize 16 / connector-registry 30 / plugin-market 15 / usage-registry 11 / session-events 16 / ts-loader 13 / browser-tools 44 / terminal-pty 29 / file-panel 20 / **file-edit 20** / arch-guard 15 / e2e 197）—— 25 套件；另设不进链的真机冒烟 `pnpm run smoke:browser`（11/11，需真 GPU/渲染进程） |
